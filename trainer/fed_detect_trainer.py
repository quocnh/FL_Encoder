...
class MyModelTrainer(ClientTrainer):
    ...
    def test_on_the_server(
        ...
        model_save_dir = "../"
        path = os.path.join(model_save_dir, 'global_model.ckpt')
        torch.save(self.model.state_dict(), path)

        a = [accuracy, precision, false_positive_rate, tpr, tnr, true_negative, false_positive, true_positive, false_negative]
